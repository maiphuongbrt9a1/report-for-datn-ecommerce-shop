...
\begin{itemize}
  ...
  \item Chương 6: Hiện thực hệ thống: Trình bày cấu trúc mã nguồn của Frontend, cấu trúc mã nguồn của Backend và các giao diện đã được hiện thực cho ứng dụng. Ngoài ra, trình bày chi tiết về danh sách các API đã được hiện thực. Bao gồm đường dẫn, parameters, và mô tả công dụng của từng api cũng như mô tả công dụng của từng parameters. Tiếp theo đó là, mô tả lại định dạng trả về của api.
  
  \item Chương 7: Kiểm thử và đánh giá hệ thống: Tiến hành kiểm tra hệ thống thông qua các cấp kiểm thử phần mềm: Unit testing, Integration Testing, System Testing, Acceptance Testing. Sau đó đánh giá hệ thống có đạt được những yêu cầu chức năng và phi chức năng đã đặt ra từ trước.
  
  \item Chương 8: Triển khai và vận hành hệ thống: Tiến hành hiện thực một phần hệ thống và giải thích cách hiện thực, cũng như triển khai hệ thống ra môi trường sử dụng được.
  
  \item Chương 9: Tổng kết: Tổng kết kết quả đạt được, rút ra kinh nghiệm và đề xuất hướng phát triển cho tương lai.
  
  \item Chương 10: Tài liệu tham khảo:  Tất cả các tài liệu nhóm đã dùng tham khảo đều được trích dẫn đầy đủ tại đây.
    
  \item Chương 11: Phụ lục
\end{itemize}
