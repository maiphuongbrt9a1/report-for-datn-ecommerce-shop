...
\begin{itemize}
  \item Đối với người quản trị viên đó là việc:
        \begin{itemize}
          ...
          \item Quản lý doanh thu: Xem doanh thu hằng ngày, tuần, tháng, năm. Xem các mặt hàng bán chạy của cửa hàng. Xem được thông tin nhân viên nào của cửa hàng là nhân viên bán hàng với doanh số cao nhất.
          \item Xem và cập nhật số lượng tồn kho của sản phẩm.
          ...
          \item Gợi ý sản phẩm cần được nhập dựa trên thứ hạng của sản phẩm bán chạy tại cửa hàng.
  ...
  \item Đối với người nhân viên đó là việc:
        \begin{itemize}
          \item Quản lý việc đóng đơn hàng và vận chuyển đơn hàng. Đó là việc xác nhận và update trạng thái của đơn hàng trong từng thời điểm đơn hàng được xử lý (xác nhận đơn, đã đóng gói, đang giao, đã giao, đang chuyển hoàn.)
          \item Xem và cập nhật số lượng tồn kho của sản phẩm.
          \item Quản lý việc hoàn tiền khi người dùng hủy đơn - hoàn tiền hoặc trả hàng - hoàn tiền: Nhân viên chỉ có quyền truy cập để xem danh sách và chi tiết các yêu cầu trả hàng/hoàn tiền từ khách hàng (bao gồm lý do, video / hình ảnh minh chứng mở hộp) nhằm mục đích đối soát đơn hàng và hỗ trợ chăm sóc khách hàng. Nhân viên hoàn toàn không có quyền phê duyệt, từ chối hay thực hiện hoàn tiền (các chức năng xử lý này đã bị vô hiệu hóa trên giao diện nhân viên và chỉ dành riêng cho Admin).
  ...
  \item Đối với người khách hàng:
        \begin{itemize}
          ...
          \item Hỗ trợ việc gợi ý các sản phẩm trong cùng một bộ (buy full set).
          ...
          \item Quản lý voucher: Lưu lại voucher để dùng sau. Và hỗ trợ việc thêm voucher vào đơn hàng.
...
\begin{itemize}
  \item Thời gian tải trang (Page Load Time): Trang chủ, trang danh mục và trang sản phẩm phải tải dưới 3 giây (tối ưu là 2 giây) trên cả thiết bị di động và máy tính.
  \item Thời gian phản hồi (Response Time): Thời gian phản hồi của API tạo mới đơn hàng, API thêm sản phẩm vào giỏ hàng và API lấy thông tin sản phẩm trong giỏ hàng phải dưới 2 giây để đảm bảo giao dịch diễn ra nhanh chóng.
  \item Bảo vệ dữ liệu người dùng (Data Protection), cụ thể mật khẩu đăng nhập tài khoản của người dùng phải được mã hóa trước khi lưu trữ tại database.
  \item Khả năng Phục hồi (Disaster Recovery)  Phải có kế hoạch và quy trình sao lưu dữ liệu 2 ngày / lần. Trong trường hợp xảy ra lỗi nghiêm trọng, hệ thống phải được khôi phục về trạng thái hoạt động gần nhất trong vòng 4 giờ.
...
\begin{itemize}
  ...
  \item Đối với người nhân viên (staff):
        \begin{itemize}
          ...
          \item Người nhân viên có thể xem thông tin các yêu cầu trả hàng/hoàn tiền được tạo bởi khách hàng nhằm mục đích kiểm tra lý do và đối soát kiện hàng thực tế. Giao diện của nhân viên hiển thị thông tin này ở chế độ chỉ đọc (Read-only), các nút phê duyệt xử lý hoặc từ chối hoàn tiền hoàn toàn bị vô hiệu hóa để đảm bảo tính an toàn tài chính. Quyền xử lý và thực hiện hoàn tiền thuộc về vai trò Admin.
          \item Người nhân viên có thể xem và cập nhật số lượng tồn kho của một sản phẩm nào đó trong cửa hàng.
        \end{itemize}
  ...
  \item Đối với người quản trị viên (admin):
        \begin{itemize}
          ...
          \item Có thể xem và cập nhật số lượng tồn kho sản phẩm nào đó trong cửa hàng.
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|m{12cm}|}
    \hline
    Use-case Name       & Người quản trị viên xem và cập nhật được số lượng hàng tồn kho của cửa hàng.
    \\  \hline
    Actors              & Quản trị viên
    \\ \hline
    Description         & Là quản trị viên tôi muốn kiểm tra và cập nhật số lượng hàng tồn kho của một sản phẩm bất kỳ tại thời điểm bất kỳ của cửa hàng.
    \\ \hline
    Pre-Conditions      & Đã đăng nhập thành công vào hệ thống
    \\ \hline
    ...
    \begin{tabular}[c]{@{}p{12cm}@{}}
      ...
      4. Chọn vào một sản phẩm cụ thể và nhấn nút "Cập nhật tồn kho".                                                                                                                  \\
      5. Modal cập nhật tồn kho hiện ra. Hệ thống hiển thị thông tin cơ bản sản phẩm (chế độ chỉ xem) và ma trận số lượng tồn kho theo kích cỡ (size) và màu sắc (cho phép chỉnh sửa). \\
      6. Nhân viên nhập số lượng tồn kho thực tế vào các ô tương ứng trong ma trận biến thể.                                                                                           \\
      7. Nhấn nút "Lưu thay đổi".                                                                                                                                                      \\
      8. Hệ thống lưu số liệu tồn kho mới vào cơ sở dữ liệu và hiển thị thông báo cập nhật thành công.                                                                                 \\
    \end{tabular}
    \\ \hline
    Alternative Flow(s) &
    \begin{tabular}[c]{@{}p{12cm}@{}}
    ...
    \\ \hline
  \end{tabular}
  \caption{Bảng Use-case Người quản trị viên xem và cập nhật được số lượng hàng tồn kho của cửa hàng.}
  \label{tab:mInfo}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|m{12cm}|}
    \hline
    Use-case Name       & Người nhân viên xem thông tin yêu cầu trả hàng/hoàn tiền.
    \\  \hline
    Actors              & Nhân viên
    \\ \hline
    Description         & Là nhân viên, tôi muốn xem danh sách và chi tiết các yêu cầu trả hàng/hoàn tiền từ khách hàng để hỗ trợ đối soát đơn hàng và giải đáp khiếu nại.
    \\ \hline
    Pre-Conditions      & Đã đăng nhập thành công vào hệ thống
    \\ \hline
    Post Conditions     & Thông tin chi tiết của yêu cầu trả hàng/hoàn tiền được hiển thị thành công dưới dạng chỉ đọc (Read-only).
    \\ \hline
    Trigger             &
    \\ \hline
    Nomal flow          &
    ...
    Alternative Flow(s) &
    \begin{tabular}[c]{@{}p{12cm}@{}}
      Nhắn tin hỗ trợ khách hàng về yêu cầu hoàn tiền:                                                           \\
      Tại bước số 7 tiến hành:                                                                                   \\
      7A1. Chọn vào mục liên hệ với khách hàng ngay trên màn hình.                                               \\
      7A2. Khung chat realtime hiển thị và tự động đính kèm thông tin sản phẩm đang khiếu nại.                   \\
      7A3. Người nhân viên nhập nội dung tin nhắn để trao đổi thêm hoặc hướng dẫn khách hàng bổ sung minh chứng. \\
      7A4. Người nhân viên nhấn nút gửi hoặc Enter để gửi tin nhắn.                                              \\
      Quay lại bước 7.
    \end{tabular}
    \\ \hline
    Exception Flow(s)   &
    ...
    \\ \hline
  \end{tabular}
  \caption{Bảng Use-case Người nhân viên xem thông tin yêu cầu trả hàng/hoàn tiền.}
  \label{tab:mInfo}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|m{12cm}|}
    \hline
    Use-case Name       & Người nhân viên xem và cập nhật được số lượng hàng tồn kho của cửa hàng.
    \\  \hline
    Actors              & Nhân viên
    \\ \hline
    Description         & Là nhân viên tôi muốn kiểm tra và cập nhật số lượng hàng tồn kho của một sản phẩm bất kỳ tại thời điểm bất kỳ của cửa hàng.
    \\ \hline
    Pre-Conditions      & Đã đăng nhập thành công vào hệ thống
    \\ \hline
    Post Conditions     & Thông tin về lượng hàng tồn kho của sản phẩm được hiển thị trên màn hình.
    ...
    \\ \hline
  \end{tabular}
  \caption{Bảng Use-case Người nhân viên xem và cập nhật được số lượng hàng tồn kho của cửa hàng.}
  \label{tab:mInfo}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|m{12cm}|}
    ...
    \begin{tabular}[c]{@{}p{12cm}@{}}
      ...
      \\
      Khách hàng đặt hàng với phương thức thanh toán online qua cổng VNPay.                   \\
      Tại bước số 8 tiến hành:                                                                \\
      8D1. Chọn vào phương thức thanh toán VNPay.                                             \\
      8D2. Điền thông tin tài khoản của khách hàng tại VNPay.                                 \\
      8D3. Quay lại bước 9.
    \end{tabular}
    \\ \hline
    Exception Flow(s)   &
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|m{12cm}|}
    ...
    Alternative Flow(s) &
    \begin{tabular}[c]{@{}p{12cm}@{}}
      Đối với các trường hợp đơn hàng được đặt và được thanh toán trước bằng hình thức thanh toán qua VNPay.                                                                                                                                   \\
      Tại bước số 4 tiến hành:                                                                                                                                                                                                                 \\
