...
Bên cạnh đó để tạo thêm sự tiện lợi cho người khách hàng trong khi mua sắm tại cửa hàng nhóm còn đề xuất tích hợp nhiều phương thức thanh toán đơn hàng khác nhau để người khách hàng lựa chọn. Đó là VNPay, COD. Không những vậy, nếu khách hàng có điều gì đó không hài lòng về sản phẩm, khách hàng có thể nhắn tin trực tiếp đến cửa hàng để được hỗ trợ và khách hàng có thể tạo yêu cầu hủy đơn, trả hàng hoàn tiền để hủy việc mua hàng. Sau khi mua hàng xong người khách hàng có thể viết đánh giá để thể hiện sự hài lòng của chính mình về sản phẩm và dịch vụ từ cửa hàng. Sau khi đơn hàng được đặt thành công, các thông tin về địa chỉ giao hàng, bảng size, sẽ được lưu lại và người khách hàng có thể sử dụng lại vào lần sau. \\
...
Đối với hoạt động xử lý yêu cầu trả hàng - hoàn tiền của người khách hàng, chỉ có người quản trị viên (Admin) mới có thẩm quyền phê duyệt, từ chối và thực hiện thanh toán hoàn tiền. Người nhân viên cửa hàng chỉ có quyền truy cập để xem danh sách và chi tiết các yêu cầu trả hàng/hoàn tiền nhằm mục đích đối soát kiện hàng thực tế nhận lại tại kho và hỗ trợ giải đáp thắc mắc cho khách hàng qua khung chat (giao diện của nhân viên hiển thị ở chế độ Read-only, các nút chấp nhận và từ chối xử lý hoàn trả hoàn toàn bị vô hiệu hóa). \\
...
Ngoài ra trong luồng xử lý việc mua hàng ta thấy cửa hàng có hỗ trợ việc thanh toán bằng nhiều hình thức khác nhau đó là thanh toán khi nhận hàng (COD) hoặc thanh toán online tích hợp (VNPay). \\
...
\begin{figure}[H]
	...
	\vspace{0.5cm}
	\caption{Sơ đồ tuần tự người quản trị viên, người nhân viên cửa hàng xử lý việc khách hàng trả hàng và yêu cầu hoàn tiền}
	\label{fig: Sơ đồ tuần tự người quản trị viên, người nhân viên cửa hàng xử lý việc khách hàng trả hàng và yêu cầu hoàn tiền}
\end{figure}
Quy trình xử lý yêu cầu trả hàng hoàn tiền được xem bởi người nhân viên và xử lý duyệt/từ chối/chuyển khoản bởi người quản trị viên. Người nhân viên cửa hàng truy cập danh sách và xem chi tiết yêu cầu hoàn tiền (bao gồm lý do, hình ảnh/video khui mở kiện hàng) dưới dạng Read-only để đối soát với kiện hàng thực tế nhận lại tại kho, sau đó báo cáo hoặc hỗ trợ khách hàng qua khung chat. Người quản trị viên sẽ là người trực tiếp nhấn nút Duyệt (Accept) hoặc Từ chối (Reject) trên giao diện quản trị của mình, tiến hành xử lý chuyển khoản hoàn tiền. \\

Quy trình xử lý yêu cầu trả hàng hoàn tiền được thực hiện như sau: \\
\begin{itemize}
	\item Luồng xử lý của người quản trị viên thực hiện:
	      \begin{itemize}
...
Phần thiết kế giao diện hệ thống này xin xem trong phần phụ lục để biết chi tiết. \\