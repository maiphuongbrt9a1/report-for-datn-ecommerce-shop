...
\definecolor{excelblue}{RGB}{189, 215, 238}
...
\begin{titlepage}
  ...
  \begin{center}
    \begin{tabular}{c}
      ...
      \\
      \\
      \textbf{\LARGE PHÁT TRIỂN HỆ THỐNG BÁN HÀNG TRỰC TUYẾN}
      \\
      \\
      \textbf{\LARGE CHO CỬA HÀNG THỜI TRANG}
      \\
      \\
  ...
  \begin{table}[h]
    \begin{tabular}{rll}
      \hspace{6 cm} & \textbf{\Large HỘI ĐỒNG:} {\Large Hội đồng 12L Khoa học Máy tính}
      \\
      \\
      \hspace{6 cm} & \textbf{\Large GVHD1:} {\Large TS. Trương Tuấn Anh}
      \\
      \\
      \hspace{6 cm} & \textbf{\Large GVHD2:}  {\Large ThS. Nguyễn Minh Tâm}
      \\
      \\
      \hspace{6 cm} & \textbf{\Large TKHĐ:} {\Large CN. Dương Huỳnh Anh Đức}
      \\
      \\
      ...
      \\
      \\
      \hspace{6 cm} & \textbf{\Large SVTH1:} {\Large Trương Tấn Sang (2212918)}
      \\
      \\
      \hspace{6 cm} & \textbf{\Large SVTH2:}  {\Large Võ Mai Phương (2114485)}
      \\
      \\
    \end{tabular}
  \end{table}
...
%%%%%%%%%%%%%%%%%CONTENTS%%%%%%%%%%%%%%%%%%%
\input{Contents/GioiThieuTongQuan}
\newpage
\input{Contents/CoSoLyThuyetVaCacHeThongLienQuan}
\newpage
