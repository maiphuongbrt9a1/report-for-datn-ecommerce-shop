...
\begin{titlepage}
  ...
  \begin{table}[h]
    \begin{tabular}{rll}
      \hspace{6 cm} & \textbf{\Large HỘI ĐỒNG:} {\Large Hội đồng 5L Đồ án chuyên ngành}
      \\
      \\
      \hspace{6 cm} & \textbf{\Large GVHD1:} {\Large TS. Trương Tuấn Anh}
      \\
      \\
      \hspace{6 cm} & \textbf{\Large GVHD2:}  {\Large CN. Nguyễn Minh Tâm}
      \\
      \\
      \hspace{6 cm} & \textbf{\Large TKHĐ:} {\Large ThS. Trần Hồng Tài}
      \\
      \\
